...
const Thumbnail = ({MovieName,ImageSrc,OverView,MediaType,ReleaseDate,VoteCount}) => {
  return (
    <div className='group cursor-pointer p-2 transation-all duration-200 ease-in transform sm:hover:scale-105 hover:z-50'> 
